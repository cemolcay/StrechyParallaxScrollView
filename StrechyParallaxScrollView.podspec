#
#  Be sure to run `pod spec lint StrechyParallaxScrollView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "StrechyParallaxScrollView"
  s.version      = "0.1"
  s.summary      = "uiscrollview with strechy and parallax top view"
  ...
  s.homepage     = "https://github.com/cemolcay/StrechyParallaxScrollView"
  ...
  s.source       = { :git => "https://github.com/cemolcay/StrechyParallaxScrollView.git", :tag => "v0.1" }
  ...
  s.source_files  = "StrechyParallaxScrollView/StrechyParallaxScrollView/*.{h,m}"
